          ...
          <div className='flex flex-wrap justify-center'>
            <div className='w-full md:w-5/12 px-12 md:px-4 ml-auto mr-auto md:mt-8'>
              ...
              <form>
                ...
                ></textarea>
                <button type='submit' className='bg-primary text-white mr-2 px-6 py-2 rounded-md'>
                  Send Message
                </button>
              </form>
            </div>
            ...
            <div className='w-full md:w-5/12 px-4 mr-auto ml-auto  md:mt-8 relative'>
              ...
              <ul>
                <li className='flex items-center pb-6 last:pb-0'>
                  <div className='text-white mr-3 h-10 w-10 rounded-1/2 flex items-center justify-center bg-primary'>
